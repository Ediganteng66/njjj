...
<div id="main_container">
       ...
       <div id="menu_tab">
            <div class="left_menu_corner"></div>
              <ul class="menu">
                ...
                <li class="divider"></li>
		            <li><a href="download-katalog.html" class="nav4">Unduh Katalog</a></li>
                <li class="divider"></li>
  ...
  <div class="left_content"> 
   ...
   <div class="footer">
        ...
        Copyright &copy; Rama project 2019. All Rights Reserved.<br />
        <a href="http://ramaproject.com/" target="blank" title="webmaster">rama-olshop</a><br />
